...
// The Blueprint "Changelog" panel: this app's git commits, filterable by a
// date/time range (From/To inputs + quick presets). Answers "what did we do
// between X and Y".
            ...
            <li key={`${c.hash}-${i}`} className="cl-item">
              ...
              <div className="cl-body">
                ...
                <div className="cl-meta">
                  ...
                  {c.filesChanged != null && <span>{c.filesChanged} file{c.filesChanged === 1 ? '' : 's'}</span>}
