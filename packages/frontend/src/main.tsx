...
//  - `?pcstats=1` → the detached PC Stats window. It must render ONLY the
//    readout — booting the full App there would open a second workspace
//    (terminals, websockets, pollers) inside a 360px utility window.
//  - otherwise → the full app.
const params = new URLSearchParams(window.location.search);
const isStatsWindow = params.has('pcstats');
