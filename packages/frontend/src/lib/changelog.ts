// Pure helpers for the Blueprint "Changelog" panel: a dated list of the app's git
// commits filtered by a date/time range. Kept out of the component so the range
...
export function rangeForPreset(preset: Preset, nowMs: number): { fromMs: number | null; toMs: number | null } {
  switch (preset) {
    case '24h':
